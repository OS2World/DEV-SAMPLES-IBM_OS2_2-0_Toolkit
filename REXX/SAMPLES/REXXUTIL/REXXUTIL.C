      ...
      if (!IsaDotdir && SameAttr(smask, finfo.attrFile) &&
        ...
        if (options&NAME_ONLY)
          ...
          if (ldp->nattrib != finfo.attrFile) {
            ...
            if (DosSetFileMode(ldp->tempfile, (USHORT)(ldp->nattrib&~
                FILE_DIRECTORY), 0L))  /* Set the new file mode      */
...
ULONG SysCls(CHAR *name, ULONG numargs, RXSTRING args[],
...
ULONG SysCurState(CHAR *name, ULONG numargs, RXSTRING args[],
    CHAR *queuename, RXSTRING *retstr)
{
  USHORT state;                        /* State                      */
...
ULONG SysDriveInfo(CHAR *name, ULONG numargs, RXSTRING args[],
                           CHAR *queuename, RXSTRING *retstr)
{
...
ULONG SysDriveMap(CHAR *name, ULONG numargs, RXSTRING args[],
                          CHAR *queuename, RXSTRING *retstr)
{
...
ULONG SysDropFuncs(CHAR *name, ULONG numargs, RXSTRING args[],
                          CHAR *queuename, RXSTRING *retstr)
{
...
ULONG SysFileDelete(CHAR *name, ULONG numargs, RXSTRING args[],
                            CHAR *queuename, RXSTRING *retstr)
{
  ULONG  rc;                           /* Ret code                   */
...
ULONG SysFileSearch(CHAR *name, ULONG numargs, RXSTRING args[],
                            CHAR *queuename, RXSTRING *retstr)
{
